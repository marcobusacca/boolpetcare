<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Eliminando il tuo account, ogni tuo dato o informazione personale verrà cancellata. Prima di cancellare l\'account, per favore salvati tutti i dati o informazioni che vuoi mantenere.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Eliminando il tuo account, ogni tuo dato o informazione personale verrà cancellata permanentemente. Perfavore inserisci la tua password per confermare l\'eliminazione dell\'account.') }}
                    </p>
                </div>
