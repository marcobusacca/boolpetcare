    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 d-flex justify-content-start align-items-end mt-5">
                <h1>Modifica il Progetto "{{ $animal->nome }}"</h1>
            </div>
            ...
            <div class="col-12 my-5">
                <form action="{{ route('admin.animals.update', $animal) }}" method="POST" class="border p-3 w-100">
                    ...
                    <div class="form-group my-4">
                        ...
                        <!-- Nome Input Text -->
                        <input type="text" name="nome" id="nome" placeholder="Inserisci il nome dell'animale" class="form-control @error('nome') is-invalid @enderror" value="{{ old('nome') ?? $animal->nome }}" required>
                        <!-- Nome Error Text -->
                        @error('nome')
                    ...
                    <div class="form-group my-4">
                        ...
                        <input type="date" name="data_di_nascita" id="data_di_nascita" placeholder="Inserisci data di nascita" class="form-control @error('data_di_nascita') is-invalid @enderror" value="{{ old('data_di_nascita') ?? $animal->data_di_nascita }}" required>
                    ...
                    <div class="form-group my-4">
                        ...
                        <!-- Genere Input Text -->
                        <input type="text" name="genere" id="genere" placeholder="Inserisci genere" class="form-control @error('genere') is-invalid @enderror" value="{{ old('genere') ?? $animal->genere }}" required>
                        <!-- Genere Error Text -->
                        @error('genere')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group my-4">
                        ...
                        <textarea name="note_aggiuntive" id="note_aggiuntive" placeholder="Inserisci note aggiuntive" class="form-control @error('note_aggiuntive') is-invalid @enderror">{{ old('note_aggiuntive') ?? $animal->note_aggiuntive }}</textarea>
